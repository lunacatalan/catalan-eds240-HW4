...
puma_wgt$status <- rep(NA, nrow(puma_wgt))

for (person in 1:nrow(puma_wgt)) {
  
  individual <- puma_wgt$NP[person]
  ...
  puma_wgt$status[person] <- ifelse(puma_wgt[["HINCP"]][person] <= extreme_threshold, 
                              "extreme",
                              ifelse(puma_wgt[["HINCP"]][person] > extreme_threshold & puma_wgt[["HINCP"]][person] <= very_low_threshold, 
                                     "very low",
                                     ifelse(puma_wgt[["HINCP"]][person] > very_low_threshold & puma_wgt[["HINCP"]][person] <= low_threshold, 
                                            "low",
                                            ifelse(puma_wgt[["HINCP"]][person] > low_threshold, "not eligible", "non"))))
}
