...
# Neighborhoods 
n_labels <- data.frame(long = c(33.968132, 34.0026595, 33.9924535, 33.9583695, 34.067236, 34.043012),
                     lat = c(-118.154518, -118.152339, -118.195177, -118.1809385, -118.263822, -118.243329), 
                     label = c("Bell Gardens", "Commerce", "Maywood", "Cudahy", "WC Project", "skid row"))
...
ggplot(data = burden_non %>% st_union()) +
  ...
  geom_text(data = n_labels, 
            ...
            family = "alice",
            size = 9) +
  labs(caption = "Over 75% of the census tracts in the neighborhoods of Commerce, Maywood, Bell Gardens, and Cudahy are eligible for affordable housing in 2022. These tracts") +
  guides(fill = "none") +
  my_theme_dark
```
...
ah_clean_plot %>%  
  ...
  annotate(geom = "text", x = 2009, y = 250000000, 
           label = "Mayor Eric Garcetti passes the \n2015 Executive Directive 13, \nSupport for Affordable Housing (ED 13).",
           color = "white",
           family = "alice",
           size = 6) +
  theme_classic() +
